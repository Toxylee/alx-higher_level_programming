...
This module contains functions that multiply 2 matrices together
"""


def chk_row(row, strn):
    """Function checks individual rows in each matrix
    for errors
    Args:
...
def deep_chk(mat, strn):
    """Function checks individual matrix for errors
    Args:
        mat: Matrix to check
...
def matrix_mul(m_a, m_b):
    """Function multiply 2 matrices and return a new list
